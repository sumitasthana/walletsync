...
BASELINE = json.load(open("data/chase/baseline_pricing_llm.json", encoding='utf-8'))
CURRENT = json.load(open("data/chase/extracted_pricing_extended.json", encoding='utf-8'))
